...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Memoria cargada por el docente {{ Auth::user()->docente->apellidos}}, {{ Auth::user()->docente->nombres}}! </div>
                  <div class="card-body">
					{!! Form::model($memoria,['route'=>['memorias',$memoria->id], 'method' => 'PUT'])!!}
					...
					<div class="btn-group" role="group">
			            ...
			            <div class="btn">
  				        @if ($memoria->observado and !$memoria->aprobado and !$memoria->prox_version<>null)
  				        {!!link_to_action('MemoriaController@duplicar', $title = 'Generar una Nueva Versión', $parameters = $memoria->id, $attributes = ['class'=>'btn btn-primary'])!!} @endif
						</div>
		            </div>
					{!! Form::close() !!}
				</div>
