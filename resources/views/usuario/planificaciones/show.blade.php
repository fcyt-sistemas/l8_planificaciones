        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Planificación cargada por el docente {{ $planificaciones->docente->apellidos}}, {{ $planificaciones->docente->nombres}}! </div>
                  <div class="card-body">
					{!! Form::model($planificaciones,['route'=>['planificaciones.index',$planificaciones->id], 'method' => 'PUT'])!!}
					...
					<div class="form-group">
						...
						@if ($planificaciones->equipo_docente_obs) {!!Form::text('equipo_docente_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					...
					<div class="input-group mb-3">
						  ...
						  @if ($planificaciones->anio_carrera_obs) {!!Form::text('anio_carrera_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="input-group mb-3">
					  <div class="input-group-prepend">
					  ...
					  @if ($planificaciones->regimen_materia_obs) {!!Form::text('regimen_materia_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="input-group mb-3">
						  <div class="input-group-prepend">
						  ...
						  @if ($planificaciones->carga_horaria_obs) {!!Form::text('carga_horaria_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					
					<div class="form-group">
						{!! Form::label('fundamentacion', 'Fundamentación:') !!}
						{!! Form::textarea('fundamentacion', null, ['class'=>'form-control', 'rows'=>'6','disabled' => 'disabled']) !!}
						@if ($planificaciones->fundamentacion_obs) {!!Form::text('fundamentacion_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="form-group">
						{!! Form::label('objetivos', 'Objetivos:') !!}
						{!! Form::textarea('objetivos', null, ['class'=>'form-control', 'rows'=>'6','disabled' => 'disabled']) !!}
						@if ($planificaciones->objetivos_obs) {!!Form::text('objetivos_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="form-group">
						...
						@if ($planificaciones->programa_contenidos_obs) {!!Form::text('programa_contenidos_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="form-group">
						...
						@if ($planificaciones->metodologia_trabajo_obs) {!!Form::textarea('metodologia_trabajo_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="form-group">
						...
						@if ($planificaciones->sistema_evaluacion_obs) {!!Form::text('sistema_evaluacion_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="form-group">
						...
						@if ($planificaciones->programa_practicos_obs) {!!Form::text('programa_practicos_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="form-group">
						{!! Form::label('bibliografia', 'Bibliografía:') !!}
						{!! Form::textarea('bibliografia', null, ['class'=>'form-control', 'rows'=>'6','disabled' => 'disabled']) !!}
						@if ($planificaciones->bibliografia_obs) {!!Form::text('bibliografia_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="form-group">
						...
						@if ($planificaciones->requisitos_rendir_obs) {!!Form::text('requisitos_rendir_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="form-group">
						...
						@if ($planificaciones->cronograma_trabajo_obs) {!!Form::text('cronograma_trabajo_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="form-group">
						...
						@if ($planificaciones->funciones_equipo_obs) {!!Form::text('funciones_equipo_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="form-group">
						...
						@if ($planificaciones->cronograma_actividades_obs) {!!Form::text('cronograma_actividades_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="form-group">
						...
						@if ($planificaciones->mecanismos_autoeval_obs) {!!Form::text('mecanismos_autoeval_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="btn-group" role="group">
						...
						<div class="btn-group">
  				        	{!!link_to_route('programa.pdf', $title = 'Descargar Programa PDF', $parameters = $planificaciones->id, $attributes = ['class'=>'btn btn-secondary'])!!}
						</div>
						<div class="btn-group">
  				        	{!!link_to_route('planificaciones.impresion', $title = 'Impresión completa', $parameters = $planificaciones->id, $attributes = ['class'=>'btn btn-secondary'])!!}
						</div>
			            <div class="btn">
  				        @if ($planificaciones->observado and !$planificaciones->aprobado and !$planificaciones->prox_version<>null)
  				        {!!link_to_action('PlanificacionesController@duplicar', $title = 'Generar una Nueva Versión', $parameters = $planificaciones->id, $attributes = ['class'=>'btn btn-primary'])!!} @endif
						</div>
		            </div>
					{!! Form::close() !!}
				</div>
