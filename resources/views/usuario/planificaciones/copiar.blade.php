...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Edición de copia de planificación, la anterior no recibirá los cambios que realice actualmente!</div>
                  <div class="card-body">
					@include('errors')
					...
					<div class="form-group">
						...
						@if ($planificaciones->metodologia_trabajo_obs) {!!Form::text('metodologia_trabajo_obs', null, ['class'=>'form-control comment', 'rows'=>'3','disabled' => 'disabled']) !!} @endif
					</div>
					<div class="form-group">
