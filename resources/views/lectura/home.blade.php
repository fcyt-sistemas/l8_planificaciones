        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">¡Todos los contenidos cargados!</div>
                  <div class="card-body">
                      Planificaciones: {{sizeof($planis)}} {!!link_to_action('PlanificacionController@index', $title = 'Ver', $parameters = [], $attributes = ['class'=>'btn btn-primary'])!!}
                    <p>
                    <div class="card-deck">
                    <div class="card text-white bg-secondary mb-3">
                      <div class="card-header">{{$dashp['cargadas']}} Cargadas</div>
                      <div class="card-body bg-light text-dark">
                        <h5 class="card-title">Planificaciones Cargadas por Usted.</h5>
                    ...
                    <div class="card text-white bg-danger mb-3">
                      ...
                      Memorias de cátedra: {{sizeof($memos)}} {!!link_to_action('MemoriaController@index', $title = 'Ver', $parameters = [], $attributes = ['class'=>'btn btn-primary'])!!}
                      <p>
                    <div class="card-deck">
                    <div class="card text-white bg-secondary mb-3">
