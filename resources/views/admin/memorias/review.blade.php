            ...
            <div class="card">
				...
				<div class="input-group mb-3">
					...
					<div class="form-group">
						...
						<div class="input-group">
						  {!! Form::text('ajus_plani_original_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>					
					...
					<div class="card bg-light mb-3">
					  ...
					  <div class="card-body">
						<div class="input-group mb-3">
						  ...
						  <div class="input-group">
						  {!! Form::text('alu_cursaron_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
						...
						<div class="input-group">
						  {!! Form::text('alu_ini_regulares_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
					    ...
					    <div class="input-group">
						  {!! Form::text('alu_regularizaron_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
						...
						<div class="input-group">
						  {!! Form::text('alu_abndonaron_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
						...
						<div class="input-group">
						  {!! Form::text('alu_promocionaron_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
						...
						<div class="input-group">
						  {!! Form::text('clases_desarrolladas_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
						...
						<div class="input-group">
						  {!! Form::text('recup_realizadas_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
					...
					<div class="form-group">
						...
						<div class="input-group">
						  {!! Form::text('regimen_curs_promo_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
					...
					<div class="form-group">
						...
						<div class="input-group">
						  {!! Form::text('cond_des_esp_curri_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
					...
					<div class="form-group">
						...
						<div class="input-group">
						  {!! Form::text('cumpl_req_rendir_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
					...
					<div class="form-group">
						...
						<div class="input-group">
						  {!! Form::text('cumpl_cron_trabajo_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
					...
					<div class="form-group">
						...
						<div class="input-group">
						  {!! Form::text('cumpl_equipo_catedra_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
					...
					<div class="form-group">
						...
						<div class="input-group">
						  {!! Form::text('cumpl_mecan_autoeval_obs', null, ['class'=>'form-control','placeholder'=>'Agregar una observación...']) !!}
						  <div class="input-group-append inline">
						  	{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
						  </div>
						</div>	
