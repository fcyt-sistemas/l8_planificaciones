            ...
            <div class="card">
                <div class="card-header justify-content-between">Listado de usuarios!
                    ...
                    <div class="form-inline">
                        {!! Form::text('name',null,['type'=>'search','name'=>'name','class'=>'form-control mr-sm-2','placeholder'=>'Nombre de usuario']) !!}    
                    </div>
                    <div class="form-inline">
                        {!! Form::text('email',null,['type'=>'search','name'=>'email','class'=>'form-control mr-sm-2','placeholder'=>'Email']) !!}    
                    </div>
                    ...
                    <!--<div class="form-inline">
                        {!! Form::text('role_user',null,['type'=>'search','name'=>'role_user','class'=>'form-control mr-sm-2','placeholder'=>'Rol']) !!}    
                    </div>-->
                    <div><button class="btn btn-default my-2 my-sm-0"type="submit">Buscar</button></div>
                    {!! Form::close() !!}
                </div>
                ...
                <div class="card-body" data-form="deleteForm">
                        <li class="list-group-item"> 
                             <div class="row">
                                  <div class="col"><b>Nombre Usuario</b></div>
