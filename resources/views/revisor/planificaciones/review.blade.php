                ...
                <div class="card-header">
                  ...
                  <div class="card-body">
					...
					<div class="input-group mb-3">
						...
						<div class="input-group">
							{!! Form::text('fundamentacion_obs', null, ['class'=>'form-control add-obs','placeholder'=>'Agregar una observación...']) !!}
					  		<div class="input-group-append inline">
					  			{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
					 		</div>
						</div>						
					...
					<div class="input-group mb-3">
						...
						<div class="input-group">
							{!! Form::text('objetivos_obs', null, ['class'=>'form-control add-obs','placeholder'=>'Agregar una observación...']) !!}
					  		<div class="input-group-append inline">
					  			{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
					 		</div>
						</div>						
					...
					<div class="input-group mb-3">
						...
						<div class="input-group">
							{!! Form::text('programa_contenidos_obs', null, ['class'=>'form-control add-obs','placeholder'=>'Agregar una observación...']) !!}
					  		<div class="input-group-append inline">
					  			{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
					 		</div>
						</div>						
					...
					<div class="input-group mb-3">
						...
						<div class="input-group">
							{!! Form::text('metodologia_trabajo_obs', null, ['class'=>'form-control add-obs','placeholder'=>'Agregar una observación...']) !!}
					  		<div class="input-group-append inline">
					  			{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
					 		</div>
						</div>
					...
					<div class="input-group mb-3">
						...
						<div class="input-group">
							{!! Form::text('sistema_evaluacion_obs', null, ['class'=>'form-control add-obs','placeholder'=>'Agregar una observación...']) !!}
					  		<div class="input-group-append inline">
					  			{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
					 		</div>
						</div>
					...
					<div class="input-group mb-3">
						...
						<div class="input-group">
							{!! Form::text('programa_practicos_obs', null, ['class'=>'form-control add-obs','placeholder'=>'Agregar una observación...']) !!}
					  		<div class="input-group-append inline">
					  			{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
					 		</div>
						</div>
					...
					<div class="input-group mb-3">
						...
						<div class="input-group">
							{!! Form::text('bibliografia_obs', null, ['class'=>'form-control add-obs','placeholder'=>'Agregar una observación...']) !!}
					  		<div class="input-group-append inline">
					  			{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
					 		</div>
						</div>
					...
					<div class="input-group mb-3">
						...
						<div class="input-group">
							{!! Form::text('requisitos_rendir_obs', null, ['class'=>'form-control add-obs','placeholder'=>'Agregar una observación...']) !!}
					  		<div class="input-group-append inline">
					  			{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
					 		</div>
						</div>
					...
					<div class="input-group mb-3">
						...
						<div class="input-group">
							{!! Form::text('cronograma_trabajo_obs', null, ['class'=>'form-control add-obs','placeholder'=>'Agregar una observación...']) !!}
					  		<div class="input-group-append inline">
					  			{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
					 		</div>
						</div>
					...
					<div class="input-group mb-3">
						...
						<div class="input-group">
							{!! Form::text('funciones_equipo_obs', null, ['class'=>'form-control  add-obs','placeholder'=>'Agregar una observación...']) !!}
					  		<div class="input-group-append inline">
					  			{!! Form::submit('Observar', ['class'=>'btn btn-outline-success add-more']) !!}
					 		</div>
						</div>
					...
					<div class="input-group mb-3">
						...
						<div class="input-group">
							{!! Form::text('cronograma_actividades_obs', null, ['class'=>'form-control add-obs','placeholder'=>'Agregar una observación...']) !!}
					  		<div class="input-group-append inline">
					...
					<div class="input-group mb-3">
						...
						<div class="input-group">
							{!! Form::text('mecanismos_autoeval_obs', null, ['class'=>'form-control add-obs','placeholder'=>'Agregar una observación...']) !!}
					  		<div class="input-group-append inline">
					  			{!! Form::submit('Observar', ['class'=>'btn btn-outline-success']) !!}
					 		</div>
						</div>
