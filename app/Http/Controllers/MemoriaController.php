...
class MemoriaController extends Controller
{
    public function __construct()
  {
    ...
    public function index()
    {
        ...
        if ($request->user()->hasRole('admin')) {
            ...
            ->paginate(10);
            return view('admin.memorias.index', ['memorias' => $memorias, 'sedes' => $sedes, 'carreras' => $carreras, 'anio_academico' => $anio_academico]);
            ...
            ->paginate(5);
            return view('revisor.memorias.index', ['memorias' => $memorias]);
            ...
            ->paginate(5);
            return view('usuario.memorias.index', ['memorias' => $memorias]);
            ...
            ->anio($request->get('anio_academico'))
            ->paginate(10);
            return view('lectura.memorias.index', ['memorias' => $memorias, 'sedes' => $sedes, 'carreras' => $carreras, 'anio_academico' => $anio_academico]);
        }
    }
    /**
    ...
    public function duplicar($id)
  {
    ...
    $carreras = Carrera::pluck('nombre', 'id');
    $sedes = Sede::pluck('nombre', 'id');
    return view('usuario.memorias.edit', ['memoria' => $memoria, 'catedras' => $catedras, 'planes' => $planes, 'carreras' => $carreras, 'sedes' => $sedes]);
  }
    ...
    public function show($id)
    {
        ...
        if (Auth::user()->hasRole('admin')) {
          return view('admin.memorias.show', ['memoria' => $memoria, 'catedras' => $catedras, 'planes' => $planes, 'carreras' => $carreras, 'sedes' => $sedes]);
        } elseif (Auth::user()->hasRole('control') && \Session::get('tipoUsuario') == 'control') {
          return view('revisor.memorias.show', ['memoria' => $memoria, 'catedras' => $catedras, 'planes' => $planes, 'carreras' => $carreras, 'sedes' => $sedes]);
        } elseif (Auth::user()->hasRole('user') && \Session::get('tipoUsuario') == 'user') {
          return view('usuario.memorias.show', ['memoria' => $memoria, 'catedras' => $catedras, 'planes' => $planes, 'carreras' => $carreras, 'sedes' => $sedes]);
        } elseif (Auth::user()->hasRole('lectura') && \Session::get('tipoUsuario') == 'lectura') {
          return view('lectura.memorias.show', ['memoria' => $memoria, 'catedras' => $catedras, 'planes' => $planes, 'carreras' => $carreras, 'sedes' => $sedes]);
        } 
    }
    ...
    public function revisar($id)
    {
        ...
        $sedes = Sede::pluck('nombre', 'id');
        if (Auth::user()->hasRole('admin')) {
            return view('admin.memorias.review', ['memoria' => $memoria, 'catedras' => $catedras, 'planes' => $planes, 'carreras' => $carreras, 'sedes' => $sedes]);
        } elseif (Auth::user()->hasRole('control') && \Session::get('tipoUsuario') == 'control') {
            return view('revisor.memorias.review', ['memoria' => $memoria, 'catedras' => $catedras, 'planes' => $planes, 'carreras' => $carreras, 'sedes' => $sedes]);
        } elseif (Auth::user()->hasRole('user') && \Session::get('tipoUsuario') == 'user') {
            return view('usuario.memorias.show', ['memoria' => $memoria, 'catedras' => $catedras, 'planes' => $planes, 'carreras' => $carreras, 'sedes' => $sedes]);
        } elseif (Auth::user()->hasRole('lectura') && \Session::get('tipoUsuario') == 'lectura') {
            return view('lectura.memorias.show', ['memoria' => $memoria, 'catedras' => $catedras, 'planes' => $planes, 'carreras' => $carreras, 'sedes' => $sedes]);
    ...
    public function impresion($id)
  {
    ...
    return PDF::loadView('admin.memorias.impresion', ['image' => $image, 'memoria' => $memoria])->stream($memoria->catedra->nombre . '-' . $memoria->anio_academico . '.pdf');
  }
  ...
  public function reporte(Request $request)
  {
    ...
    $image = base64_encode(file_get_contents(public_path('/images/logo-tr.png')));
    return PDF::loadView('admin.memorias.reporte', ['image' => $image], ['memorias' => $memorias])->stream('memorias.pdf');
